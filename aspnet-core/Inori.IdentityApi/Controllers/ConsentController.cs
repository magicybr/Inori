...
using Inori.IdentityApi.Models.Consent;
    ...
    public class ConsentController : Controller
    {
           ...
           Client client, Resources resources)
        {
            ...
            vm.IdentityScopes = resources.IdentityResources
                .Select(c => CreateScopeViewModel(c, vm.ScopesConsented.Contains(c.Name) || model == null)).ToArray();
        ...
        private async Task<ProcessConsentResult> ProcessConsent(ConsentInputModel model)
        {
            ...
            else if (model?.Button == "yes")
            {
                if (model.ScopesConsented != null && model.ScopesConsented.Any())
                {
                    ...
                    {
                        scopes = scopes.Where(c => c != IdentityServer4.IdentityServerConstants.StandardScopes.OfflineAccess);
                    }
